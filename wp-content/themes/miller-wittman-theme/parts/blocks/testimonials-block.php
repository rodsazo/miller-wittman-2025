...
<div class="testimonials">
    ...
    <div class="container">
        ...
        <div class="testimonials__slider" data-p-slider-id="<?php echo $slider_id; ?>" data-transition="fadeHeight">
            ...
            <div class="testimonials__slides" data-p-slider="<?php echo $slider_id; ?>__slides">
            ...
            <?php if( count($testimonials) > 1): ?>
                ...
                <div class="testimonials__arrows">
                    <button type="button" class="testimonials__arrow" data-p-slider="<?php echo $slider_id; ?>__prev">
                    ...
                    <button type="button" class="testimonials__arrow" data-p-slider="<?php echo $slider_id; ?>__next">
                        <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
