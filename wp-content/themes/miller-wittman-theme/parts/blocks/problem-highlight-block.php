...
<div class="container container--large">
    <div class="problemHighlight">    
        <div class="problemHighlight__inner<?php echo $has_title ? '' : ' problemHighlight__inner--noTitle'; ?>">
            <?php if( $has_title ): ?>
            ...
            <div class="problemHighlight__content<?php echo $has_title ? '' : ' problemHighlight__content--fullWidth'; ?>">
